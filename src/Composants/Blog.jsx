...
const Blog =({ theme }) => {
   ...
   return(
    ...
    >
      {/* HERO */}
      <section className=" py-[30px] md:py-[50px] lg:py-[100px] relative w-full ">
            <img src={Post} alt="" className="rounded-[12px]"/>
            <div className="absolute  top-[65%] flex flex-col w-[50%] px-10">
          ...
          <p className="text-[20px] sm:text-[28px] md:text-[32px] lg:text-[36px] font-semibold w-[750px]">
           ...
           <div className="flex flex-wrap gap-x-4 items-center">
                      <img src={Image8} alt="" className="rounded-full w-8 h-8" />
