...
>
  <section className="md:mt-[5%] mt-[10%] flex flex-col w-full sm:w-[80%] md:w-[70%] lg:w-[50%] px-0 sm:px-[5%] md:px-[10%] lg:px-[15%] font-worksans">
    <button className="bg-[#4B6BFB] px-3 py-2 rounded-[6px] text-white text-[14px] w-fit">
      Technology
    </button>
    <p className="text-[20px] sm:text-[28px] md:text-[32px] lg:text-[36px] font-semibold w-full lg:w-[750px] mt-4">
      The Impact of Technology on the Workplace: How Technology is Changing
    </p>
    <div className="flex flex-wrap gap-x-4 items-center mt-4">
  ...
  <div className="px-0 sm:px-[5%] md:px-[10%] lg:px-[15%] py-7">
    <img src={Image10} alt="" className="w-full h-auto object-cover rounded-[12px]" />
  </div>

  <section className="py-3 flex flex-col sourceSerif w-full px-4 sm:px-[5%] md:px-[10%] lg:px-[15%]">
  ...
  <section
    className={`mx-auto w-full max-w-[800px] flex flex-col sourceSerif justify-center items-center rounded-[12px] py-3 mt-[60%] md:mt-[60px] px-4 sm:px-8 ${
      theme === "light" ? "bg-[#E8E8EA] text-black" : "bg-[#2a2a2a] text-white"
    }`}
  >
    <p className="text-[24px] p-4 text-center italic">
  ...
  <div className="px-0 sm:px-[5%] md:px-[10%] lg:px-[15%] py-7">
    <img src={Image11} alt="" className="w-full h-auto object-cover rounded-[12px]" />
  </div>

  <section
    className={`mx-auto w-full max-w-[800px] flex flex-col justify-center font-worksans items-center rounded-[12px] py-3 mt-[60%] md:mt-0 px-4 ${
      theme === "light" ? "bg-[#E8E8EA] text-[#696A75]" : "bg-[#2a2a2a] text-[#d1d1d1]"
    }`}
  >
